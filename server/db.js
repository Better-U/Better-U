...
knex.schema.createTableIfNotExists('nutrition_record', function (nutrition) {
  ...
  nutrition.decimal('serving')
  nutrition.string('servingSize')
  nutrition.decimal('cal')
  nutrition.decimal('carbs')
  nutrition.decimal('fat')
  nutrition.decimal('fiber')
  nutrition.decimal('sodium')
  nutrition.decimal('protein')
  nutrition.decimal('water')
}).then(function () {
...
knex.schema.createTableIfNotExists('cardio_record', function (cardio) {
  ...
  cardio.decimal('duration')
  cardio.decimal('intensity')
  cardio.decimal('pace')
  cardio.string('type')
  cardio.date('date')
  cardio.string('time')
